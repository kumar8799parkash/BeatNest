    ...
    fetch(`https://beatnest-1.onrender.com/playlists/${id}`)                    // `data/playlists.json`
        ...
        .then(playlist => {
            ...
            songsArray.forEach((song, songIndex) => {
                ...
                const songLikeCont = document.createElement('div');
                songLikeCont.classList.add('song-like-cont');

                const heartLikeLogo = document.createElement('img');
                heartLikeLogo.classList.add('song-like-heart-logo');
                heartLikeLogo.src = 'svgs/likeHeartLogoWhite.svg';
                songLikeCont.appendChild(heartLikeLogo);
                ...
                songItem.appendChild(songLikeCont);
